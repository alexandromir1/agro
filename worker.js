// Версия для Cloudflare Worker (используйте этот файл, если создаете отдельный Worker)
// Для Cloudflare Pages Functions используйте functions/analyze.js
...
export default {
  async fetch(request, env) {
    ...
    if (request.method !== "POST") {
      return new Response(
        JSON.stringify({ error: "Метод не поддерживается. Используйте POST." }),
